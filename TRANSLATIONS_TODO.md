...
- **Contact email**: `data/legal.json` `_meta.contactEmail` is still the placeholder `[your-contact-email]`; set it before launch — it fills the Privacy contact line and the Subscribe "notify me" mailto.
