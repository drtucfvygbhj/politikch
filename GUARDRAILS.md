...
| `monitor_sources.py` — runs first | ckan.opendata.swiss, every fetched host's robots.txt, own domains' certificates | — | Crawl-delay honoured | none | ✅ stops the job if a licence code or robots.txt changed (SRC-10); certificate warnings (HOST-04) |
